...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection('sqlite_jobs')->create('jobs', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection('sqlite_jobs')->create('job_batches', function (Blueprint $table) {
        ...
        Schema::connection('sqlite_jobs')->create('failed_jobs', function (Blueprint $table) {
            $table->id();
